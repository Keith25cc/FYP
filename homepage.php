...
<body>
    ...
    <section id="section1">
        ...
        <h2 style="text-align: center; margin: 80px 50px;">Key Features of Our Automated Forex Trading System</h2>
...
<section class="why">
  <div class="container">
    <h2 class="title" style="margin-top:180px;">Why Choose Us?</h2>
    <ul class="menu">
...
<section id="section2">
    <div id="commentCarousel" class="carousel slide" data-ride="carousel">
        <h1 style="margin:50px 0px 40px 40px; font-family:Bodoni MT;">Feedback Section</h1>
